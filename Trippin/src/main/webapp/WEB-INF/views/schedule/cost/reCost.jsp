...
<div class="top">
	...
	<div class="cost">
		<div class="cin"><input id="tmon" style="border: 0; width: 78vw; height: 9.5vh;   background-color: silver; font-size: 50px;" type="number" name="tot_money"  step="1000" placeholder="금액 입력 " value="${cvo.tot_money }" ></div>
	</div>
</div>
<div class="mid">
	<div class="mid1">
	...
	<div class="mid2">
		<div>내용</div>
		<div><input autocomplete="off" id="cont" style="border: 0; width: 40vw; height: 6vh; font-size: 30px; " type="text" name="content" placeholder="내용을 입력 해주세요" required="required" value="${cvo.content }"></div>
	</div>
	<div class="mid3">
		<div class="mid3f">
