                    ...
                    <div class="table">
                        ...
                        <div class="tb-1">
                      	...
                      	<c:if test="${mOne.KIND ==1}">
	                      	<div class="tb-1">
		                        <div class="t1-title"> <a href="javascript:void(0);" onclick="opner('${cpath }/member/')" style="text-decoration: none; color:gray; cursor: pointer; " >여행기/여행기댓글 </a></div><!-- 여행기 상세 경로 넣기 -->
		                            <div class="t1-text">${mOne.SCLCT}</div>
	                       	</div>
                      	</c:if>
                      	<c:if test="${mOne.KIND !=1}">
	        				<div class="tb-1">
		                        <div class="t1-title"> <a href="javascript:void(0);" onclick="opner('${cpath }/member/')" style="text-decoration: none; color: rgba(58, 58, 58, 0.4); cursor: pointer; " >여행기/여행기댓글 </a></div><!-- 여행기 상세 경로 넣기 -->
